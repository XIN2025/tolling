...
import (
	...
	"github.com/rajeshsharmax2c/tolling/aggregator/client"
...
func (h *InvoiceHandler) handleGetInvoice(w http.ResponseWriter, r *http.Request) error {
	fmt.Println("htting the get invoice from the gateway")
	...
	if err != nil {
		return fmt.Errorf("invalid OBU id")
	}

	// Pass the obuID to the GetInvoice method
